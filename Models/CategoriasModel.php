...
class CategoriasModel extends Query
{
    ...
    public function verficarCategoria($categoria)
    {
    ...
    {
        $sql = "UPDATE categorias SET estado = ? WHERE id = ?"; /* Cambiar el estado del registro */
        $array = array(0, $idCat); /* El estado va ser igual a 0 */
